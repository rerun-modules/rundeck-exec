...
# Created: Fri Jul 10 15:04:35 PDT 2015
#
#/ usage: rundeck-run:output-text  --id <> [ --last-lines <>] [ --format <text>]  --server-url <"${SERVER_URL:-}">  --api-token <> 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --last-lines) rerun_option_check $# $1; LAST_LINES=$2 ; shift ;;
